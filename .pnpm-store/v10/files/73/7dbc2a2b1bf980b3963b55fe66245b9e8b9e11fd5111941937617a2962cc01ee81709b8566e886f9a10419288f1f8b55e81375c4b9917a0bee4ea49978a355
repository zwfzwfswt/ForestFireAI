...
declare const datesInQuarter: (date: Dayjs, year: number, quarter: number, lang: string) => Date[];
declare const isQuarterFullyDisabled: (value: Dayjs, lang: string, disabledDate?: DisabledDateType) => boolean;
declare const isSelectableQuarterDate: (value: Dayjs, lang: string, disabledDate?: DisabledDateType) => boolean;
...
declare const getValidDateOfQuarter: (date: Dayjs, year: number, quarter: number, lang: string, disabledDate?: DisabledDateType) => dayjs.Dayjs;
declare const normalizeQuarterDate: (value: Dayjs, lang: string, disabledDate?: DisabledDateType) => dayjs.Dayjs;
...
//#endregion
export { DefaultValue, buildPickerTable, correctlyParseUserInput, datesInMonth, datesInQuarter, getDefaultValue, getValidDateOfMonth, getValidDateOfQuarter, getValidDateOfYear, isQuarterFullyDisabled, isSelectableQuarterDate, isValidRange, normalizeQuarterDate };