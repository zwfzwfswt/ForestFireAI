export type EmojiStatus = 'component' | 'fully-qualified' | 'minimally-qualified' | 'unqualified';
export declare const componentStatus: EmojiStatus;
/**
 * Base item
 */
 ...
 */
export declare function parseEmojiTestFile(data: string): EmojiTestData;