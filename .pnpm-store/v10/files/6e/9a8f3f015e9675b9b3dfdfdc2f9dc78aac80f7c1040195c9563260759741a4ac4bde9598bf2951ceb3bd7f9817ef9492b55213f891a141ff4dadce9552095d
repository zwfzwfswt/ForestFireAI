...
declare const presets: {
  '@vue/composition-api': import("unimport").InlinePreset;
  pinia: import("unimport").InlinePreset;
  'vue-demi': import("unimport").InlinePreset;
  'vue-i18n': import("unimport").InlinePreset;
  'vue-router-composables': import("unimport").InlinePreset;
  vue: import("unimport").InlinePreset;
  'vue/macros': import("unimport").InlinePreset;
  vitest: import("unimport").InlinePreset;
  rxjs: import("unimport").InlinePreset;
  'date-fns': import("unimport").InlinePreset;
  ahooks: () => ImportsMap;
