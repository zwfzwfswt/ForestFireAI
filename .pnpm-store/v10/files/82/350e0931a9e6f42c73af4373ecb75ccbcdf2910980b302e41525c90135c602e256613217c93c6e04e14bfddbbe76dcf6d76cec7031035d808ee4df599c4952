...
//#region ../../packages/components/date-picker-panel/src/props/basic-quarter-table.d.ts
declare const basicQuarterTableProps: {
...
type BasicQuarterTableProps = ExtractPropTypes<typeof basicQuarterTableProps>;
type BasicQuarterTablePropsPublic = ExtractPublicPropTypes<typeof basicQuarterTableProps>;
//#endregion
export { BasicQuarterTableProps, BasicQuarterTablePropsPublic, basicQuarterTableProps };