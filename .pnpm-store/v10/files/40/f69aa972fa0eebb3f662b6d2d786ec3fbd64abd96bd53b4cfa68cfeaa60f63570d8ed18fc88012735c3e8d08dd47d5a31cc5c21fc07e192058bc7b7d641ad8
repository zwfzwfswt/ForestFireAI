...
import { YAMLException } from "./_chunks/libs/js-yaml.mjs";
/**
 ...
 */
export declare function parseYAML<T = unknown>(text: string, options?: YAMLParseOptions): T;
/**
 ...
 */
export declare function stringifyYAML(value: any, options?: YAMLStringifyOptions): string;
