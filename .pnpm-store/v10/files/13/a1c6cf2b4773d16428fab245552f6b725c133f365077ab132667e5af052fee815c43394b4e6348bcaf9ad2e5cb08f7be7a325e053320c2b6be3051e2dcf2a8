 ...
 */
export declare function findSimilarRegexItemSequences(items: EmojiItemRegex[]): SimilarRegexItemSequenceResult | undefined;
/**
 * Merge similar sequences
 *
 * Accepts callback to run optimisation on created subset
 */
export declare function mergeSimilarRegexItemSequences(items: EmojiItemRegex[], merge: SimilarRegexItemSequence, optimise?: (set: SetEmojiItemRegex) => EmojiItemRegex): EmojiItemRegex[];
/**
 * Merge similar items
 */
export declare function mergeSimilarItemsInSet(set: SetEmojiItemRegex): EmojiItemRegex;