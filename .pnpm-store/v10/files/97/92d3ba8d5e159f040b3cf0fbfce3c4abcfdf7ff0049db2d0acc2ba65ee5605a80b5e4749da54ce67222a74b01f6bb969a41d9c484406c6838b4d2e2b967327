 ...
 */
export declare function guessQualifiedEmojiSequence(sequence: number[]): number[];
/**
 * Base type to extend
 */
 ...
 */
export declare function getQualifiedEmojiVariation<T extends BaseSequenceItem>(item: T): T;
/**
 * Get qualified emoji variations for set of emojis, ignoring duplicate entries
 */
export declare function getQualifiedEmojiVariations<T extends BaseSequenceItem>(items: T[]): T[];