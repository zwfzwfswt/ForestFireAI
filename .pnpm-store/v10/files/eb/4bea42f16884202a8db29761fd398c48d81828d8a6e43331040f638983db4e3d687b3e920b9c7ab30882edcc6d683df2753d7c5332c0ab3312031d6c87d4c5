		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
				...
				__props.showHeader && (0, vue.unref)(tableLayout) === "fixed" ? (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
					...
					"onSetDragVisible"
				])], 6)], 2)), [[(0, vue.unref)(require_index.default), (0, vue.unref)(handleHeaderFooterMousewheel)]]) : (0, vue.createCommentVNode)("v-if", true),
				(0, vue.createElementVNode)("div", {
					ref: "bodyWrapper",
					class: (0, vue.normalizeClass)((0, vue.unref)(ns).e("body-wrapper"))
				}, [(0, vue.createVNode)((0, vue.unref)(require_index$3.ElScrollbar), {
				...
				__props.showSummary && (0, vue.unref)(tableLayout) === "fixed" ? (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
					...
					"sum-text",
					"summary-method"
				])], 6)], 2)), [[vue.vShow, !isEmpty.value], [(0, vue.unref)(require_index.default), (0, vue.unref)(handleHeaderFooterMousewheel)]]) : (0, vue.createCommentVNode)("v-if", true),
