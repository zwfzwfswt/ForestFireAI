 ...
 */
export type UniversalIconLoader = (collection: string, icon: string, options?: IconifyLoaderOptions) => Promise<string | undefined>;
/**
 ...
 */
export type AutoInstall = boolean | ((name: string) => Promise<void | undefined>);
/**
