 ...
 */
export declare function parseJSON5<T = unknown>(text: string, options?: JSON5ParseOptions): T;
/**
 ...
 */
export declare function stringifyJSON5(value: any, options?: JSON5StringifyOptions): string;
