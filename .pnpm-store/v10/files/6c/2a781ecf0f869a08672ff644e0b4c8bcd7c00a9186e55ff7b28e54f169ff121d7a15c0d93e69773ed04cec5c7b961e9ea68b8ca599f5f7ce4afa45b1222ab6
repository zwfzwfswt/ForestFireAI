 ...
 */
export declare function getEmojiSequenceFromString(value: string): number[];
/**
 ...
 */
export declare function getSequenceFromEmojiStringOrKeyword(value: string): number[];
/**
 ...
 */
export declare function splitEmojiSequences(sequence: number[], separator?: number): number[][];
/**
 ...
 */
export declare function joinEmojiSequences(sequences: number[][], separator?: number): number[];
/**
 * Get unqualified sequence
 */
export declare function getUnqualifiedEmojiSequence(sequence: number[]): number[];