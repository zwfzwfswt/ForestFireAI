...
declare const useOldValue: (props: {
  ...
  add: {
    (value: number, unit?: _$dayjs.ManipulateType): Dayjs;
    (value: number, unit: _$dayjs.QUnitType): Dayjs;
  };
  subtract: {
    (value: number, unit?: _$dayjs.ManipulateType): Dayjs;
    (value: number, unit: _$dayjs.QUnitType): Dayjs;
  ...
  startOf: {
    (unit: _$dayjs.OpUnitType): Dayjs;
    (unit: _$dayjs.QUnitType | _$dayjs.OpUnitType): Dayjs;
  };
  endOf: {
    (unit: _$dayjs.OpUnitType): Dayjs;
    (unit: _$dayjs.QUnitType | _$dayjs.OpUnitType): Dayjs;
  ...
  utcOffset: () => number;
  isBefore: {
    (date?: _$dayjs.ConfigType, unit?: _$dayjs.OpUnitType): boolean;
    (date?: _$dayjs.ConfigType, unit?: _$dayjs.QUnitType): boolean;
  };
  isSame: {
    (date?: _$dayjs.ConfigType, unit?: _$dayjs.OpUnitType): boolean;
    (date?: _$dayjs.ConfigType, unit?: _$dayjs.QUnitType): boolean;
