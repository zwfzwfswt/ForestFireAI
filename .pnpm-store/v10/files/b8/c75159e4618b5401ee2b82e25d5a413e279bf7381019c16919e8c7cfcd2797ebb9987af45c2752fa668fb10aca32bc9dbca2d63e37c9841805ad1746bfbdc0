 ...
 */
export declare function createOptimisedRegexForEmojiSequences(sequences: number[][]): string;
/**
 ...
 */
export declare function createOptimisedRegex(emojis: (string | number[])[]): string;