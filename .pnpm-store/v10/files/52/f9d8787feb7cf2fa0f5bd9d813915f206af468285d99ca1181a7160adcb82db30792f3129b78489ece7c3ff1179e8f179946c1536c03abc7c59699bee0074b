  ...
  setup(props, context) {
    ...
    const loadTableData = datas => {
      ...
      if (sYLoad) {
        ...
        if (!props.showOverflow) {
          (0, _log.errLog)('vxe.error.reqProp', ['table.show-overflow']);
        }
        if (process.env.NODE_ENV === 'development') {
          if (props.spanMethod) {
          ...
          if (!targetColumn.fixed && isMaxFixedColumn) {
            if (_vXETable.VXETable.modal) {
              _vXETable.VXETable.modal.message({
                status: 'error',
                content: _conf.default.i18n('vxe.table.maxFixedCol', [maxFixedSize])
              });
            }
            return (0, _vue.nextTick)();
          }
    ...
    const handleGlobalKeydownEvent = evnt => {
      ...
      if (internalData.isActivated) {
        tablePrivateMethods.preventEvent(evnt, 'event.keydown', null, () => {
          ...
          const isEsc = (0, _event.hasEventKey)(evnt, _event.EVENT_KEYS.ESCAPE);
          const isBack = (0, _event.hasEventKey)(evnt, _event.EVENT_KEYS.BACKSPACE);
          ...
          const isF2 = (0, _event.hasEventKey)(evnt, _event.EVENT_KEYS.F2);
          const isContextMenu = (0, _event.hasEventKey)(evnt, _event.EVENT_KEYS.CONTEXT_MENU);
    ...
    tablePrivateMethods = {
      ...
      preventEvent(evnt, type, args, next, end) {
        let evntList = _vXETable.VXETable.interceptor.get(type);
        // 兼容老版本
        if (!evntList.length && type === 'event.clearEdit') {
          evntList = _vXETable.VXETable.interceptor.get('event.clearActived');
          if (process.env.NODE_ENV === 'development') {
            if (evntList.length) {
      ...
      getCellLabel(row, column) {
        ...
        if (formatter) {
          ...
          if (_xeUtils.default.isString(formatter)) {
            const gFormatOpts = _vXETable.VXETable.formats.get(formatter);
            const tcFormatMethod = gFormatOpts ? gFormatOpts.tableCellFormatMethod || gFormatOpts.cellFormatMethod : null;
            cellLabel = tcFormatMethod ? tcFormatMethod(formatParams) : '';
          } else if (_xeUtils.default.isArray(formatter)) {
            const gFormatOpts = _vXETable.VXETable.formats.get(formatter[0]);
            const tcFormatMethod = gFormatOpts ? gFormatOpts.tableCellFormatMethod || gFormatOpts.cellFormatMethod : null;
    ...
    const renderEmptyContenet = () => {
      ...
      if (slots.empty) {
        ...
        if (renderTableEmptyView) {
          return (0, _vn.getSlotVNs)(renderTableEmptyView(emptyOpts, params));
        }
      }
      ...
      (0, _vue.nextTick)(() => {
        ...
        if (process.env.NODE_ENV === 'development') {
          ...
          if (importConfig && importOpts.types && !importOpts.importMethod && !_xeUtils.default.includeArrays(_vXETable.VXETable.globalConfs.importTypes, importOpts.types)) {
            (0, _log.warnLog)('vxe.error.errProp', [`export-config.types=${importOpts.types.join(',')}`, importOpts.types.filter(type => _xeUtils.default.includes(_vXETable.VXETable.globalConfs.importTypes, type)).join(',') || _vXETable.VXETable.globalConfs.importTypes.join(',')]);
          }
          if (exportConfig && exportOpts.types && !exportOpts.exportMethod && !_xeUtils.default.includeArrays(_vXETable.VXETable.globalConfs.exportTypes, exportOpts.types)) {
            (0, _log.warnLog)('vxe.error.errProp', [`export-config.types=${exportOpts.types.join(',')}`, exportOpts.types.filter(type => _xeUtils.default.includes(_vXETable.VXETable.globalConfs.exportTypes, type)).join(',') || _vXETable.VXETable.globalConfs.exportTypes.join(',')]);
          }
        }
        if (process.env.NODE_ENV === 'development') {
          const customOpts = computeCustomOpts.value;
        ...
        if (props.autoResize) {
          ...
          resizeObserver = (0, _resize.createResizeEvent)(handleOptimizeResize ? () => {
            if (props.autoResize) {
    ...
    const renderVN = () => {
       ...
       * 自定义列
       */
      initStore.custom ? (0, _vue.h)((0, _vue.resolveComponent)('vxe-table-custom-panel'), {
        ref: refTableCustom,
        customStore
      }) : (0, _vue.createCommentVNode)(),
      /**
       * 筛选
       */
      initStore.filter ? (0, _vue.h)((0, _vue.resolveComponent)('vxe-table-filter-panel'), {
        ref: refTableFilter,
        filterStore
      }) : (0, _vue.createCommentVNode)(),
      /**
       * 导入
       */
      initStore.import && props.importConfig ? (0, _vue.h)((0, _vue.resolveComponent)('vxe-table-import-panel'), {
       ...
       * 导出/导出
       */
      initStore.export && (props.exportConfig || props.printConfig) ? (0, _vue.h)((0, _vue.resolveComponent)('vxe-table-export-panel'), {
       ...
       * 快捷菜单
       */
      isMenu ? (0, _vue.h)((0, _vue.resolveComponent)('vxe-table-menu-panel'), {
        ref: refTableMenu
      }) : (0, _vue.createCommentVNode)(),
      /**
       * 通用提示
       ...
       * 工具提示
       */
      hasUseTooltip ? (0, _vue.h)((0, _vue.resolveComponent)('vxe-tooltip'), Object.assign({
        ref: refTooltip
      }, tipConfig)) : (0, _vue.createCommentVNode)(),
      /**
       * 校验提示
       */
      hasUseTooltip && props.editRules && validOpts.showMessage && (validOpts.message === 'default' ? !height : validOpts.message === 'tooltip') ? (0, _vue.h)((0, _vue.resolveComponent)('vxe-tooltip'), Object.assign({
        ref: refValidTooltip,
        class: [{
          'old-cell-valid': editRules && _conf.default.cellVaildMode === 'obsolete'
