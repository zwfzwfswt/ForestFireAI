...
import { ROOT_PICKER_INJECTION_KEY } from "./src/constants.mjs";
...
//#endregion
export { ElDatePickerPanel, ElDatePickerPanel as default, ROOT_PICKER_INJECTION_KEY, datePickerPanelProps };
